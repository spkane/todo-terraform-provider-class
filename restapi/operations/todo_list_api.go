...
type TodoListAPI struct {
	...
	// JSONConsumer registers a consumer for a "application/spkane.todo-list.v1+json" mime type
	JSONConsumer runtime.Consumer

	// JSONProducer registers a producer for a "application/spkane.todo-list.v1+json" mime type
...
func (o *TodoListAPI) ConsumersFor(mediaTypes []string) map[string]runtime.Consumer {
	...
	for _, mt := range mediaTypes {
		...
		case "application/spkane.todo-list.v1+json":
			result["application/spkane.todo-list.v1+json"] = o.JSONConsumer
...
func (o *TodoListAPI) ProducersFor(mediaTypes []string) map[string]runtime.Producer {
	...
	for _, mt := range mediaTypes {
		...
		case "application/spkane.todo-list.v1+json":
			result["application/spkane.todo-list.v1+json"] = o.JSONProducer
