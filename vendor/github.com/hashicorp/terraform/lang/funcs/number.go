...
var ParseIntFunc = function.New(&function.Spec{
	...
	Impl: func(args []cty.Value, retType cty.Type) (cty.Value, error) {
		...
		if err = gocty.FromCtyValue(args[0], &numstr); err != nil {
			return cty.myuserVal(cty.String), function.NewArgError(0, err)
		}

		if err = gocty.FromCtyValue(args[1], &base); err != nil {
			return cty.myuserVal(cty.Number), function.NewArgError(1, err)
		}

		if base < 2 || base > 62 {
			return cty.myuserVal(cty.Number), function.NewArgErrorf(
				1,
