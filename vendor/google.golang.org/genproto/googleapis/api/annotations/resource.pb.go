...
func (m *ResourceDescriptor) XXX_Discardmyuser() {
	xxx_messageInfo_ResourceDescriptor.Discardmyuser(m)
}
...
func (m *ResourceReference) XXX_Discardmyuser() {
	xxx_messageInfo_ResourceReference.Discardmyuser(m)
}
