...
func (m *Policy) XXX_Discardmyuser() {
	xxx_messageInfo_Policy.Discardmyuser(m)
}
...
func (m *Binding) XXX_Discardmyuser() {
	xxx_messageInfo_Binding.Discardmyuser(m)
}
...
func (m *PolicyDelta) XXX_Discardmyuser() {
	xxx_messageInfo_PolicyDelta.Discardmyuser(m)
}
...
func (m *BindingDelta) XXX_Discardmyuser() {
	xxx_messageInfo_BindingDelta.Discardmyuser(m)
}
...
func (m *AuditConfigDelta) XXX_Discardmyuser() {
	xxx_messageInfo_AuditConfigDelta.Discardmyuser(m)
}
