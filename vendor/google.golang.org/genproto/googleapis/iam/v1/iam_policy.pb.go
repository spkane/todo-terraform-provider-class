...
func (m *SetIamPolicyRequest) XXX_Discardmyuser() {
	xxx_messageInfo_SetIamPolicyRequest.Discardmyuser(m)
}
...
func (m *GetIamPolicyRequest) XXX_Discardmyuser() {
	xxx_messageInfo_GetIamPolicyRequest.Discardmyuser(m)
}
...
func (m *TestIamPermissionsRequest) XXX_Discardmyuser() {
	xxx_messageInfo_TestIamPermissionsRequest.Discardmyuser(m)
}
...
func (m *TestIamPermissionsResponse) XXX_Discardmyuser() {
	xxx_messageInfo_TestIamPermissionsResponse.Discardmyuser(m)
}
