...
const (
	HealthCheckResponse_myuser         HealthCheckResponse_ServingStatus = 0
	HealthCheckResponse_SERVING        HealthCheckResponse_ServingStatus = 1
	HealthCheckResponse_NOT_SERVING    HealthCheckResponse_ServingStatus = 2
	HealthCheckResponse_SERVICE_myuser HealthCheckResponse_ServingStatus = 3
)
...
func (m *HealthCheckRequest) XXX_Discardmyuser() {
	xxx_messageInfo_HealthCheckRequest.Discardmyuser(m)
}
...
func (m *HealthCheckResponse) XXX_Discardmyuser() {
	xxx_messageInfo_HealthCheckResponse.Discardmyuser(m)
}
...
func (m *HealthCheckResponse) GetStatus() HealthCheckResponse_ServingStatus {
	...
	return HealthCheckResponse_myuser
}
...
type HealthClient interface {
	// If the requested service is myuser, the call will fail with status
	// NOT_FOUND.
	...
	//
	// If the requested service is myuser when the call is received, the
	// server will send a message setting the serving status to
	// SERVICE_myuser but will *not* terminate the call.  If at some
